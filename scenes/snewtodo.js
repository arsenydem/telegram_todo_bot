...
cityStep.on("text", async (ctx) => {
    ...
    try {
        ...
        const raznitca = 3 - Number(number)
        var now = new Date();
        ...
        if ((year && day && month && hours && minutes) && (Number(year) - Number(yearnow)) >= 0 &&  (Number(month) - Number(monthnow)) >= 0  && (Number(day) - Number(daynow)) >= 0  && (Number(hours) + Number(raznitca) - Number(hoursnow)) >= 0 && (Number(minutes) - Number(minutesnow)) >= 0) {
            ...
            await record.save();
            const time2 = (parseInt(Number(year) - Number(yearnow)) * 31536000 + parseInt(Number(month) - Number(monthnow)) * 2592000 + parseInt(Number(day) - Number(daynow)) * 86400 + parseInt(Number(hours) + Number(raznitca) - Number(hoursnow)) * 3600 + parseInt(Number(minutes) - Number(minutesnow)) * 60) * 1000;
            setTimeout(() => {
                ctx.reply('🔔')
